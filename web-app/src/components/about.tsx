    ...
    <div className='content'>
      ...
      <div className='columns'>
        ...
        <div className='column'>
          ...
          <p>
            In my current role, I am currently working as an Advanced Software Engineer for <a href='https://aptiv.com' target='_blank'>Aptiv</a>. Aptiv is a tier one automotive supplier and technology company. My team and I work in advanced development for <a href='https://www.aptiv.com/user-experience' target='_blank'>Active Safety and User Experience</a> business lines. Due to the nature of advanced development, much of what I am currently working on is confidential, as my team is tasked with developing intellectual property for Aptiv. Essentially, I work as a product and concept developer for Aptiv's AS/UX product lines.
          </p>
          <p>
